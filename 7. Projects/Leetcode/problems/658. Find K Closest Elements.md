...
[[2026-03-22|2026-03-22 Sun, 12:55]]
再換一個想法：「我可以排除掉左半邊的答案嗎？」
在 lower bound 問題中，等於是在問「`arr[lm] < target`」，如果左半邊的最大值都不滿足需求的話，那就等於我可以排除掉左半邊了。

`arr[lm] >= target` 這個問題的本質是在說：解答是否存在於左半邊？
