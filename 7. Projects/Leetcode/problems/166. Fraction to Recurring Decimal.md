...
[[2025-12-18|2025-12-18 Thu, 11:54]]
`~~` 是雙重位元 NOT 運算子，常被用來做「快速取整」，但它有個致命限制： 
**JavaScript 的位元運算會先將數字轉為 32-bit 有號整數** 32-bit signed integer 的範圍： 
- 最大值：2³¹ - 1 = **2,147,483,647**（約 21 億） 
- 最小值：-2³¹ = **-2,147,483,648**
